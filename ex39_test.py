...
print "Nevada's abbreviation is %s" % hashmap.get(states, 'Nevada')
print "Ariona's abbreviation is %s" % hashmap.get(states, 'Arizona')

# do it by using the state then cities dict
print '-' * 10
print "Michigan has: %s" % hashmap.get(cities, hashmap.get(states, 'Michigan'))
print "Florida has: %s" % hashmap.get(cities, hashmap.get(states, 'Florida'))
print "Arizona has: %s" % hashmap.get(cities, hashmap.get(states, 'Arizona'))
