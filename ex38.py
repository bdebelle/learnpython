...
while len(stuff) != 10: # Run this loop until 10 items are in the list 'stuff'
	...
	stuff.append(next_one) # append(stuff, next_one) Appends current item equal to variable 'next_one' to the list 'stuff'
...
print ' '.join(stuff) # join(' ', stuff) : Take all the items in the list 'stuff' and join them with a space
print '#'.join(stuff[3:5]) #join(stuff[3:5], #) : Take Items in cardinal positons 3 & 5 and join them together with a #
